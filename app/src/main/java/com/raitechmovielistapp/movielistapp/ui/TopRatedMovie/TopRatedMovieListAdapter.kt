...
class TopRatedMovieListAdapter(public val context: Context) :PagedListAdapter<MovieTopRated,RecyclerView.ViewHolder>(MovieDiffCallBack()){
    ...
    class MovieDiffCallBack:DiffUtil.ItemCallback<MovieTopRated>(){
    ...
    class MovieItemViewHolder (movieListitemBinding: TopratedmovieListitemBinding):RecyclerView.ViewHolder(movieListitemBinding.root){
        ...
        fun bind(movieTopRated: MovieTopRated?,context: Context){

            itemView.tv_movietitle.text=movieTopRated?.title
            val movieposturl= POSTER_BASE_URL+movieTopRated?.posterPath
